...
- No CI is configured yet. Build with `dotnet build WitcherScriptMerger.sln` and run `dotnet format whitespace WitcherScriptMerger.sln --verify-no-changes` before opening a PR — a reviewer will otherwise have to ask you to fix both.
